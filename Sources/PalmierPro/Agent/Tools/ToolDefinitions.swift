        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "tracks": [
                        "type": "object",
                        "description": "Animate several properties at once: {property: keyframe rows}, keys from volumeDb, opacity, rotation, position, scale, crop, speed. An empty array clears that property's track. Mutually exclusive with property/keyframes. \(keyframeRowShapes)",
                        "additionalProperties": ["type": "array", "items": ["type": "array"]],
                    ],
                    "property": [
                        "type": "string",
                        "enum": ["volumeDb", "opacity", "rotation", "position", "scale", "crop", "speed"],
