...
extension InspectorView {
    ...
    func effectsTabContent(clips: [Clip]) -> some View {
        VStack(alignment: .leading, spacing: 0) {
            adjustSection(title: L10n.string("Looks"), effectIds: [], clips: clips) {
            ...
            adjustSection(title: L10n.string("Effects"), effectIds: effectsEffectIds, clips: clips) {
                ...
                adjustSubgroup(title: L10n.string("Subject Key"), controls: subjectKeyControls, clips: clips)
                adjustSubgroup(title: L10n.string("Behind Subject"), controls: occlusionControls, clips: clips)
                adjustSubgroup(title: L10n.string("Subject Reveal"), controls: subjectRevealControls, clips: clips)
                adjustToggleRow(
