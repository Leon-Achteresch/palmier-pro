        ...
        VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
            SettingsSection(title: "Own API Keys") {
                APIKeyField(
                    ...
                    explanation: "Generate speech, sound effects, and music straight from your ElevenLabs account. Billed by ElevenLabs. Stored in the macOS Keychain.",
                ...
                APIKeyField(
                    ...
                    explanation: "Generate and edit video and images with Gemini Omni Flash — swap objects, rewrite scenes, and recut footage. Billed by Google. Stored in the macOS Keychain.",
