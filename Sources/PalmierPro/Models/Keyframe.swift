...
extension Clip {
    func supportsKeyframes(for property: AnimatableProperty) -> Bool {
        ...
        case .scale:
            switch mediaType {
            case .video, .image, .lottie, .sequence, .text, .motion:
                return true
            case .audio, .subtitle, .adjustment:
                return false
            }
        case .crop:
            switch mediaType {
            case .video, .image, .lottie, .sequence, .motion:
                return true
            case .audio, .text, .subtitle, .adjustment:
                return false
            }
        case .speed:
            return supportsSpeedRamp
        }
    }
    ...
    func hasActiveKeyframes(for property: AnimatableProperty) -> Bool {
        ...
        case .speed: speedTrack?.isActive == true
        }
    }
    ...
    func keyframeFrames(
        ...
        case .speed: frames = speedTrack?.frames(in: offsets) ?? []
        }
    ...
    func arrivalInterpolation(for property: AnimatableProperty, atFrame frame: Int) -> Interpolation? {
        ...
        case .blur:     return read(blurKeyframeTrack)
