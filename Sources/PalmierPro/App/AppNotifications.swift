...
enum AppNotifications {
    ...
    static func generationBody(assetName: String, assetType: ClipType, count: Int) -> String {
        if count > 1 {
            ...
            case .motion: return L10n.string("\(count) motion scenes are ready in Palmier Pro.")
            case .adjustment: return L10n.string("\(count) adjustment layers are ready in Palmier Pro.")
            }
        }
        ...
        case .motion: return L10n.string("Your motion scene is ready.")
        case .adjustment: return L10n.string("Your adjustment layer is ready.")
        }
    }
}
