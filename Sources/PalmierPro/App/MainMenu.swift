...
enum MainMenuBuilder {
    ...
    private static func editMenu() -> NSMenuItem {
        ...
        let adjustmentItem = NSMenuItem(title: L10n.string("Add Adjustment Layer"), action: #selector(EditorActions.addAdjustmentLayer(_:)), keyEquivalent: "y")
    ...
    private static func viewMenu() -> NSMenuItem {
        ...
        let safeAreasItem = NSMenuItem(title: L10n.string("Safe Areas"), action: #selector(EditorActions.toggleSafeAreaGuides(_:)), keyEquivalent: "'")
