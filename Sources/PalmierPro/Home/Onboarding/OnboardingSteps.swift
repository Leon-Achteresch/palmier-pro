    ...
    var body: some View {
        VStack(alignment: .leading, spacing: AppTheme.Spacing.xxl) {
            VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
                OnboardingTitle(L10n.string("Ready"))
                OnboardingDetail(L10n.string("Watch the tutorial or start creating."))
            }
            if sampleState == .failed {
                Text(L10n.string("Sample project couldn’t be opened. Try again."))
