...
import { MessageSideContext } from "@/components/beui/agents/message-context";
...
export { MessageScroller } from "@/components/beui/agents/message-scroller";
export type { MessageScrollerProps } from "@/components/beui/agents/message-scroller";
